...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* Blobs */}
      <div className="blob" style={{ width: 500, height: 500, background: '#6366f1', top: '-15%', left: '-10%', position: 'fixed' }} />
      <div className="blob blob-2" style={{ width: 400, height: 400, background: '#10b981', bottom: '-10%', right: '-8%', position: 'fixed' }} />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass-2 rounded-2xl p-8" style={{ boxShadow: '0 32px 64px rgba(0,0,0,0.4)' }}>
          <h1 className="text-2xl font-bold mb-1" style={{ color: '#f1f5f9', letterSpacing: '-0.02em' }}>Welcome back</h1>
          <p className="text-sm mb-7" style={{ color: '#64748b' }}>Sign in to your finance dashboard</p>
